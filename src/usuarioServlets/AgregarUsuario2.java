...
/**
 * Servlet implementation class AgregarUsuario2
 */
@WebServlet("/AgregarUsuario2")
public class AgregarUsuario2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AgregarUsuario2() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (status == 1 && tipoUsuario.equals("Administrador")) {
			response.sendRedirect(request.getContextPath() + "/jsp/AdminUsuarios.jsp?activo=AdminUsuarios");
		} else if (status == 1 && tipoUsuario.equals("Usuario")) {
