...
/**
 * Servlet implementation class ActualizarUsuarioNormal
 */
@WebServlet("/ActualizarUsuarioNormal")
public class ActualizarUsuarioNormal extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarUsuarioNormal() {
        super();
