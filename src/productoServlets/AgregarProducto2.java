...
/**
 * Servlet implementation class AgregarProducto2
 */
@WebServlet("/AgregarProducto2")
public class AgregarProducto2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AgregarProducto2() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ProductoModel producto = new ProductoModel(nombre_producto, categoria_producto, urlimagen_producto, descripcion_producto, precio_producto, cantidad_producto);
