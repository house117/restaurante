		...
		<div class="col-md-8 order-md-1">
			...
			<div class="form-check">
				<label class="form-check-label"> <input type="checkbox"
					class="form-check-input" value="">Casita
				</label>
			</div>
			<div class="form-check">
				<label class="form-check-label"> <input type="checkbox"
					class="form-check-input" value="">Trabajo
				</label>
			</div>
			<div class="form-check">
				<label class="form-check-label"> <input type="checkbox"
					class="form-check-input" value="">Otra dirección
				</label>
			</div>
			...
			<form class="needs-validation" novalidate>
				<div class="row">
					<div class="col-md-6 mb-3">
						<label for="firstName">Nombre</label> <input type="text"
							...
							required>
						<div class="invalid-feedback">Nombre válido requerid.</div>
					</div>
					<div class="col-md-6 mb-3">
						<label for="lastName">Apellidos</label> <input type="text"
							class="form-control" id="lastName" placeholder="" value=""
							required>
						<div class="invalid-feedback">Apellido válido requerido</div>
					</div>
				</div>
				<div class="mb-3">
					<label for="address">Dirección</label> <input type="text"
						...
						required>
					<div class="invalid-feedback">Por favor ingresa tu dirección
						de envío</div>
				</div>

				<div class="mb-3">
					<label for="address2">Dirección línea 2 <span
				...
				<div class="row">
					...
					<div class="col-md-4 mb-3">
						...
						<div class="invalid-feedback">Pon un estado válido</div>
					</div>
				...
				<div class="d-block my-3">
					...
					<div class="custom-control custom-radio">
						<input id="debit" name="paymentMethod" type="radio"
							...
							class="custom-control-label" for="debit">Tarjeta de
							débito</label>
					</div>
					<div class="custom-control custom-radio">
				...
				<div class="row">
					<div class="col-md-6 mb-3">
						<label for="cc-name">Nombre en la tarjeta</label> <input
							type="text" class="form-control" id="cc-name" placeholder=""
							required> <small class="text-muted">Nombre
							completo como viene en la tarjeta</small>
						<div class="invalid-feedback">El nombre en la tarjeta es
							obligatorio</div>
					</div>
					<div class="col-md-6 mb-3">
						<label for="cc-number">Número de tarjeta</label> <input
							...
							required>
						<div class="invalid-feedback">Número de tarjeta de crédito
							requerido</div>
					</div>
				</div>
				<div class="row">
